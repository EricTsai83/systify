...
import { SYSTEM_DESIGN_KIND_DESCRIPTIONS, SYSTEM_DESIGN_KIND_TITLES, type SystemDesignKind } from "./lib/systemDesign";
      ...
      if (text.length === 0) {
        ...
        if (!validation.ok || !mermaidOk) {
          ...
          outcome = {
            kind: "generated",
            title,
            description: SYSTEM_DESIGN_KIND_DESCRIPTIONS[args.kind],
