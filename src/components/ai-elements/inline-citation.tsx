...
/* eslint-disable react-hooks/set-state-in-effect -- shadcn-generated; carousel index sync mirrors Embla's snap callbacks via setState */
...
export const InlineCitationCarouselHeader = ({ className, ...props }: InlineCitationCarouselHeaderProps) => (
  <div className={cn("flex items-center justify-between gap-2 bg-secondary p-2", className)} {...props} />
);
