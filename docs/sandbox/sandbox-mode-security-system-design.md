...
1. **Throwaway lifecycle**: sandboxes are provisioned on demand by Sandbox grounding activation or LLM-backed Design Docs generation, auto-stop within minutes of idleness, and auto-delete within 48 hours. Even a successful exfiltration attempt has a small window of compounding access — there is no long-lived sandbox to reuse.
