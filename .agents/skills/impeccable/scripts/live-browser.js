...
void main() {
  ...
  function restoreSessionWithoutWrapper(reason, activeSessions) {
    ...
    const restoreFile =
      currentPreviewMode === "svelte-component" ? currentPreviewFile : currentSourceFile || currentPreviewFile;
    if (restoreFile) {
  ...
  function resumeSession() {
    ...
    if (wrapper.dataset.impeccablePreview === "svelte-component" && svelteComponentSession?.sessionId !== sessionId) {
      wrapper.remove();
